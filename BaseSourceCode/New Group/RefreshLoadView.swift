...
open class RefreshLoadView: UIView{
    ...
    func Init(){
        ...
        arrowLayer.transform = CATransform3DRotate(arrowLayer.transform, CGFloat(Float.pi), 0, 0, 1)
    ...
    func animateCAlayer(_ layer: CALayer) {
        ...
        layer.transform = CATransform3DRotate(layer.transform, CGFloat(Float.pi), 0, 0, 1)
    ...
    open func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        if scrollView.isDragging {
            ...
            if state == .loadMore {
                ...
                self.loadactivityView.frame = CGRect(x: self.frame.origin.x, y: scrollView.contentSize.height-10, width: picWidth, height: picHeight)
                if delegate != nil {
